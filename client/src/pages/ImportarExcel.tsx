  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      for (const sheetName of workbook.SheetNames) {
        ...
        console.log(`[Import] Sheet: "${sheetName}" → modulo: ${modulo || 'NOT MAPPED'}`);
        ...
        console.log(`[Import] Sheet: "${sheetName}" → jsonData: ${jsonData.length} rows, parsed: ${records.length} records`);
