...
import { InsertUser, users, expedientes, autos, oficios, alertas } from "../drizzle/schema";
import type { InsertExpediente, InsertAuto, InsertOficio, InsertAlerta } from "../drizzle/schema";
